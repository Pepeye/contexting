...
Using appropriate template based on detected language:
- Rust projects: `prp/templates/prp_base_rust.md`
- Go projects: `prp/templates/prp_base_go.md`  
- Bun/TypeScript projects: `prp/templates/prp_base_bun.md`
- Other projects: `prp/templates/prp_base.md`
